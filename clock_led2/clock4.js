...
window.onload = function()
{
	...
	var s;
	s = date.getHours();
	drawfont(0,70,(s/10)>>0,g);
	drawfont(40,70,s%10,g);
	drawfont(70,70,10,g);
	s = date.getMinutes();
	drawfont(100,70,(s/10)>>0,g);
	drawfont(140,70,s%10,g);
	// drawfont(170,70,10,g);
	// s = date.getSeconds();
	// drawfont(200,70,(s/10)>>0,g);
	// drawfont(240,70,s%10,g);
	s = date.getMonth()+1;
	if(s >= 10)
